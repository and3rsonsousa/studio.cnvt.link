	...
	return (
		<div>
			...
			<AnimatePresence initial={false} exitBeforeEnter>
				...
				{/* - Lista */}
				{display === 3 && (
					<motion.div layout key="list" initial={slideH.initial} animate={slideH.animate} exit={slideH.exit}>
				...
				{/* - Grid */}
				{display === 4 && (
					<motion.div layout key="grid" initial={slideH.initial} animate={slideH.animate} exit={slideH.exit}>
