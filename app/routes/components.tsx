	...
	return (
		<div className="p-8">
			...
			<div>
				...
				<Code>h5</Code>{" "}
				<h5>Culpa molestias reprehenderit reciendis molestiae.</h5>
				<Code>h6</Code>{" "}
				<h6>Laudantium, dolorem iure! Cumque, sequi!</h6>
			</div>
			...
			<div>
				...
				<p className="text-xx">
					...
					Veniam, magnam rerum maiores nihil obcaecati fugiat quam
					qui, ducimus culpa quisquam at sequi perferendis ut?
					Voluptate tempore sed ut deserunt consectetur!
				</p>

				<Code>.text-xxx</Code>

				<p className="text-xxx">
					Eligendi quaerat eveniet quos pariatur! Ad doloribus ipsa
					perspiciatis, a repellat molestiae modi et, facere hic,
					autem veniam minima. Iure molestias itaque neque veritatis
					optio nemo unde praesentium quod dolor.
				</p>
			</div>
...
function Code({
	...
	return (
		<pre
			className={`mb-2 mt-4 whitespace-pre-wrap rounded-md bg-rose-100 text-sm font-bold text-rose-600 ${
